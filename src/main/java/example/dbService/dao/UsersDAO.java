...
public class UsersDAO {
    ...
    public UsersDataSet getUserByLogin(String name) throws HibernateException {
        return this.get(getUserId(name));
    }
    ...
    public long insertUser(String name, String email, String pass) throws HibernateException {
        return (Long) session.save(new UsersDataSet(name, email, pass));
    }
}
